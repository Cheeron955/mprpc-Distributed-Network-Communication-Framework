...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendsListsRequest* Arena::CreateMaybeMessage<::fixbug::GetFriendsListsRequest>(Arena*);
template<> ::fixbug::GetFriendsListsResponse* Arena::CreateMaybeMessage<::fixbug::GetFriendsListsResponse>(Arena*);
...
class GetFriendsListsRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendsListsRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendsListsRequest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendsListsRequest)
 private:
  class _Internal;
...
class GetFriendsListsResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendsListsResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendsListsResponse";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendsListsResponse)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsListsRequest::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsListsRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListsRequest.userid)
  return _internal_userid();
}
inline void GetFriendsListsRequest::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendsListsRequest::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListsRequest.userid)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendsListsResponse::_internal_has_result() const {
...
inline const ::fixbug::ResultCode& GetFriendsListsResponse::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFriendsListsResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListsResponse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendsListsResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendsListsResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendsListsResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendsListsResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendsListsResponse.result)
  return _internal_mutable_result();
}
inline void GetFriendsListsResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendsListsResponse.result)
}

// repeated bytes friends = 2;
inline int GetFriendsListsResponse::_internal_friends_size() const {
...
inline std::string* GetFriendsListsResponse::add_friends() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendsListsResponse.friends)
  return _internal_add_friends();
}
inline const std::string& GetFriendsListsResponse::_internal_friends(int index) const {
  return friends_.Get(index);
}
inline const std::string& GetFriendsListsResponse::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListsResponse.friends)
  return _internal_friends(index);
}
inline std::string* GetFriendsListsResponse::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendsListsResponse.friends)
  return friends_.Mutable(index);
}
inline void GetFriendsListsResponse::set_friends(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListsResponse.friends)
...
inline void GetFriendsListsResponse::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendsListsResponse.friends)
}
inline void GetFriendsListsResponse::set_friends(int index, const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendsListsResponse.friends)
}
inline std::string* GetFriendsListsResponse::_internal_add_friends() {
  return friends_.Add();
}
inline void GetFriendsListsResponse::add_friends(const std::string& value) {
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendsListsResponse.friends)
}
...
inline void GetFriendsListsResponse::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendsListsResponse.friends)
}
inline void GetFriendsListsResponse::add_friends(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendsListsResponse.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendsListsResponse::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendsListsResponse.friends)
  return friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendsListsResponse::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendsListsResponse.friends)
  return &friends_;
}
